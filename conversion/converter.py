...
def _make_romaji_convertor():
    ...
    def __romaji2kana():
        ...
        def _romaji2katakana(text):
            ...
            #print "_romaji2katakana result = ", re_roma2kana.sub(lambda x: romaji_dict[x.group(0)], result)
...
if __name__ == "__main__":
    ...
    if args[1]:
        ...
        print MODE[args2.mode]
        for line in lines:
            text = line[args2.number]
            if args2.mode == 1:
                print text.decode('utf-8'), "\t", hiragana2katakana(text)
            elif args2.mode == 2:
                print text.decode('utf-8'), "\t", katakana2hiragana(text)
            elif args2.mode == 3:
                print text.decode('utf-8'), "\t", romaji2hiragana(text)
            elif args2.mode == 4:
                print text.decode('utf-8'), "\t", romaji2katakana(text)
            elif args2.mode == 5:
                print text.decode('utf-8'), "\t", kana2romaji(text)
            else:
